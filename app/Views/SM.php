         ...
         <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link active" href="javascript:void(0);"><i class="bx bx-folder"></i>Surat Masuk</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="<?=base_url('home/SK')?>"><i class="bx bx-folder"></i>Surat Keluar</a>
                    </li>
                  </ul>
                </div>
      </nav>
              ...
              <table class="table datatable" id="mitraTable">
                <thead>
                  <tr style="font-weight: bold; color: black; font-size: larger;">
                    ...
                    <td align="center" scope="col">Pengirim</td>
                    <td align="center" scope="col">Penerima</td>
                    <td align="center" scope="col">Surat</td>
                  </tr> 
                </thead>
                <tbody>
                <?php
                ...
                ?>
                  <tr>
                    <td align="center" scope="col"><?= $no++ ?></td>
                    <td align="center" scope="col"><?= $key->pengirim ?></td>
                    <td align="center" scope="col"><?= $key->real ?></td>
                    <td align="center" scope="col">
                      <!-- Button to trigger modal -->
                      <button class="btn btn-primary view-surat" data-surat="<?= $key->surat ?>">View Surat</button>
                    </td>
                  </tr>
                <?php
                  }
...
<?php endif; ?>
          ...
          <div class="memo-body">
            <p><strong>Yth :</strong> <?= $key->real ?></p>
            <p><strong>Dari :</strong><?= $key->pengirim ?></p>
            <br>
