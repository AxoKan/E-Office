      ...
      <nav>
         <div class="row">
                <div class="col-md-12">
                  ...
                  <li class="nav-item">
                      <a class="nav-link" href="<?=base_url('home/SM')?>"><i class="bx bx-folder"></i>Surat Masuk</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link active" href="javascript:void(0);"><i class="bx bx-folder"></i>Surat Keluar</a>
                    </li>
            ...
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center mb-3">
                <div class="search-container">
                  ...
                  <button class="btn btn-success">Kirim Surat</button></a>
              ...
              <table class="table datatable" id="mitraTable">
                ...
                ?>
                  <tr>
                    ...
                    <td align="center" scope="col"><?= $key->penerima ?></td>
