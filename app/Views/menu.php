...
<style>
  ...
  body {
    ...
    .menu-header {
  font-size: 12px; /* Makes the label smaller */
  font-weight: bold;
  color: #333; /* Darker color to stand out */
  padding: 10px 15px;
  text-transform: uppercase;
  border: none; /* Removes the line under the label */
...
<li class="menu-header">MAIN MENU</li>
  ...
  <li class="menu-item <?php if($uri->getSegment(2) == "dashboard"){echo "active";}?> ">
    ...
    <li class="menu-item <?php if($uri->getSegment(2) == "SM"){echo "active";}?> <?php if($uri->getSegment(2) == "SK"){echo "active";}?>">
  <a href="<?= base_url("home/SM")?>" class="menu-link">
      <i class="menu-icon tf-icons bx bx-folder
"></i>
      <div data-i18n="Layouts">Surat </div>
    </a>
    </li>
  
    <li class="menu-item <?php if($uri->getSegment(2) == "cuti"){echo "active";}?> <?php if($uri->getSegment(2) == "AC"){echo "active";}?>">
  <a href="<?= base_url("home/Cuti")?>" class="menu-link">
      <i class="menu-icon tf-icons bx bx-run"></i>
      <div data-i18n="Layouts">Izin Cuti</div>
    </a>
    </li>
...
<li class="menu-header">ADMIN MENU</li>
    <li class="menu-item <?php if($uri->getSegment(2) == "admin"){echo "active";}?><?php if($uri->getSegment(2) == "petugas"){echo "active";}?> ">
