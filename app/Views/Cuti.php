      ...
      <nav>
         <div class="row">
                <div class="col-md-12">
                  ...
                  <li class="nav-item">
                      <a class="nav-link active" href="javascript:void(0);"><i class="bx bx-run"></i>Permohonan Cuti</a>
                    </li>
                  <li class="nav-item">
                      <a class="nav-link" href="<?=base_url('home/AC')?>"><i class="bx bx-run"></i>Ajukan Cuti</a>
                    </li>
              ...
              <table class="table datatable" id="mitraTable">
                <thead>
                  <tr style="font-weight: bold; color: black; font-size: larger;">
                    ...
                    <td align="center" scope="col">Jenis Cuti</td>
                    <td align="center" scope="col">Nama Pengawai</td>
                    <td align="center" scope="col">Mulai</td>
                    <td align="center" scope="col">Selesai</td>
                    <td align="center" scope="col">Keterangan</td>
                  </tr> 
                </thead>
                <tbody>
                <?php
                ...
                ?>
                  <tr>
                    <td align="center" scope="col"><?= $no++ ?></td>
                    <td align="center" scope="col"><?= $key->Jenis_Cuti ?></td>
                    <td align="center" scope="col"><?= $key->real ?></td>
                    <td align="center" scope="col"><?= $key->awal ?></td>
                    <td align="center" scope="col"><?= $key->akhir ?></td>
                    <td align="center" scope="col"><?= $key->keterangan?></td>
